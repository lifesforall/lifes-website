...
const translationsNl = {
  ...
  "Life⁻s works closer to the plant to help growers unlock more value from the resources already used in the greenhouse—automatically and without another complex workflow.": "Life⁻s werkt dichter bij de plant om telers meer waarde te laten halen uit de middelen die al in de kas worden gebruikt—automatisch en zonder een extra complexe werkwijze.",
  ...
  "Aligned incentives": "Gelijkgerichte belangen",
  ...
  "The trial was designed, controlled, and measured by": "De proef is ontworpen, gecontroleerd en gemeten door",
  ...
  "Arda’s background in farming and electronics engineering gave him a way to approach the problem from both sides. The technology had to create measurable crop value, but it also had to respect the grower’s reality.": "Arda’s achtergrond in landbouw en elektronica gaf hem de mogelijkheid het probleem van beide kanten te benaderen. De technologie moest meetbare gewaswaarde creëren én aansluiten op de dagelijkse realiteit van de teler.",
  ...
  "Ali leads the development of the Life⁻s platform and its move from research into greenhouse use.": "Ali leidt de ontwikkeling van het Life⁻s-platform en de stap van onderzoek naar toepassing in de kas.",
